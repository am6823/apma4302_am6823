...
solver_case = os.environ.get("SOLVER_CASE", "split_mg")
...
if solver_case == "direct":
    pc = "monolithic direct"
    params = {
        "ksp_type": "preonly",
        "pc_type": "lu",
...
elif solver_case == "split_direct":
    pc = "fieldsplit direct"
    params = {
        "ksp_type": "fgmres",
        "pc_type": "fieldsplit",
...
elif solver_case == "split_mg":
    pc = "fieldsplit multigrid"
    params = {
        "ksp_type": "fgmres",
        "pc_type": "fieldsplit",
        "pc_fieldsplit_type": "multiplicative",
    ...
    raise ValueError(f"Unknown SOLVER_CASE: {solver_case}")
