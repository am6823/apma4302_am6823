...
parser.add_argument("--dt", type=float, default=1000.0)
parser.add_argument("--tmax", type=float, default=100000.0)

args, unknown = parser.parse_known_args()

# Remove custom Python arguments before PETSc/Firedrake reads sys.argv
...
outfile = VTKFile(f"result/q4c_Ra{Ra_value:.0e}_N{N}.pvd")
